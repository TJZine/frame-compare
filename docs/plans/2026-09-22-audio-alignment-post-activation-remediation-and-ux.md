...
F2 combines AA-02 and AA-03 under one fresh token:
`continuous-origin-qualified-channel-corroboration-2097152-v13`.
No other planned package bumps identity. F2 must test current-v13 computed/confirmed
...
equivalent proof against application/trims/cache/promotion. Test the single v13 bump
...
active mono authority, metadata v4, and v13 confirmed-cache misses. Historical plans
...
| Cache | Current v13 write/reuse, stale v12 computed/embedded/confirmed source-set misses, explicit manual precedence and no channel authority/promotion. |
...
architecture changes beyond accepted v13 misses, UX requiring material redesign,
...
| Lost confirmed reuse | Explicit accepted v13 whole-set misses, no migration or identity split; users may reconfirm. |
