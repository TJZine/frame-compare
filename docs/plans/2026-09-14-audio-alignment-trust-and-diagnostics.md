...
| R7 activation | Implementation complete; physical-Windows acceptance pending | `3739ac6d` | Qualified mono authority is active under fresh v12, channel evidence remains provisional, and the in-video marker is ASCII-safe. Full Python/static/docs, native, distribution, and fresh Docker/Linux proof passed; exact rebuilt physical-Windows package/visible acceptance remains blocking. |
