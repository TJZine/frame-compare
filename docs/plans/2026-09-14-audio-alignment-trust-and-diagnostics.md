...
| R7 activation | Dependency-ready | — | Activate only qualified mono authority under fresh v12, keep channel evidence provisional, repair the ASCII-unsafe video marker, and obtain fresh default/cache/trim/package/physical-Windows proof. |
