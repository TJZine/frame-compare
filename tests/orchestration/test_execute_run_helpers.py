...
def test_write_metrics_cache_uses_cache_inputs_stats_when_video_paths_are_provided(
    ...
    fingerprint = cache_io.compute_cache_key(
        ...
        metric_active_rect=metric_active_rect_for_cache_inputs(cache_inputs, config),
    )
...
""",
    ...
    fingerprint = cache_io.compute_cache_key(
        ...
        metric_active_rect=metric_active_rect_for_cache_inputs(discovered_paths, config),
    )
