...
OUTPUTS:
  - /Users/tristan/Software/frame-compare/.agent-workflow/runs/2026-02-02__p6-7-8__runner/impl-v5.md
---
...
- Gate failure in `ruff` persists on `scripts/fc2_autopilot.py`, which is outside the allowed write set.
