...
- Fixed Spec Anchor signature bullets to use unqualified callable names (e.g., `get_vs_loader(...)`) so `scripts/validate_spec_anchors.py` can match against SSOT sections.
- No SSOT/spec changes required.
- Scope unchanged.
...
## Plan to Review
Read file: .agent-workflow/runs/2026-02-02__p6-7-7__rundependencies/plan-v2.md
...
## Output
Write file: .agent-workflow/runs/2026-02-02__p6-7-7__rundependencies/plan-review-v2.md
