...
OUTPUTS:
  - .agent-workflow/runs/2026-02-02__p6-7-5__runrequest/review-v1.md
  - .agent-workflow/index.md (updated)
---

# Review Report: RunRequest Dataclass
...
**Date:** 2026-02-02
**Files Reviewed:** 7
**Commit Subject:** `feat(orchestration): add RunRequest dataclass`
...
- [x] No drift detected vs orchestration-module.md §4.4.1
...
- [x] `RunRequest` is exported from `frame_compare.orchestration`

## Next Steps

### If APPROVED

- ✅ Phase 6 Item 6.7 (RunRequest) complete
- ➡️ Proceed to next checklist item

## NEXT AGENT PROMPT (COPY/PASTE)

### ✅ Run Complete: 2026-02-02__p6-7-5__runrequest

**Orchestrator Actions:**
1. Commit the changes:
    ```bash
   git add -A
   git commit -m "feat(orchestration): add RunRequest dataclass" \
     -m "Run: 2026-02-02__p6-7-5__runrequest" \
