...
- **Fix 1:** Add host-side bind-mount directories with `.gitkeep` files to prevent DevContainer startup failures when the paths are missing.
...
### 11. Bind-mount directories for DevContainer

**Purpose:** Ensure host paths exist for DevContainer bind mounts.
