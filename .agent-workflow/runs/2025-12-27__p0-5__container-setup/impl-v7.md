...
**Plan Review Report:** `.agent-workflow/runs/2025-12-27__p0-5__container-setup/plan-review-v9.md` (APPROVED)

This revision adds `procps` to the runtime image so the DevContainer bootstrap can run `ps`.

## Files Changed (Exact Paths)

### Modified
- `Dockerfile` — Install `procps` in the runtime image.
- `CHANGELOG.md` — Note runtime dependency update for DevContainer bootstrap.
- `docs/DECISIONS.md` — Record decision for runtime `procps`.
...
## Files to Read
1. Read file: `.agent-workflow/runs/2025-12-27__p0-5__container-setup/impl-v7.md`
2. Read file: `.agent-workflow/runs/2025-12-27__p0-5__container-setup/plan-v9.md`
3. Read file: `.agent-workflow/runs/2025-12-27__p0-5__container-setup/plan-review-v9.md`
...
## Output
Write file: `.agent-workflow/runs/2025-12-27__p0-5__container-setup/verify-v6.md`
