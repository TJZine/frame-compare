...
# Implementation Plan: Render Encoders (v5)

## Changes Since plan-v4

- **Scope:** Restored explicit "Out of Scope" section.
- **File List:** Re-added `docs/DECISIONS.md` and `CHANGELOG.md` update requirements.
- **Test Fixtures:** Specified stdout as bytes (`b"24000/1001\n"`); added explicit "MUST mock" rule.
...
Write file: .agent-workflow/runs/2026-01-01__p4-5__encoders/plan-review-v5.md
