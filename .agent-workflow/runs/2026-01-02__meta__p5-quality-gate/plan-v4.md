...
- **Updated SSOT first** (per plan-review-v3 requirement): Added "VapourSynth Availability Guards" subsection to `testing-strategy.md` section 3.2
- **Updated Spec Anchors** to reference new SSOT heading "#### VapourSynth Availability Guards"
- **Removed "No SSOT spec changes" note** from Notes for Coding Agent — this run now includes SSOT update
...
Write file: .agent-workflow/runs/2026-01-02__meta__p5-quality-gate/plan-review-v4.md
