...
- **Verification:** Updated verification commands to target `plan-v5.md`.
...
UV_CACHE_DIR=./.uv_cache uv run --no-sync python scripts/validate_spec_anchors.py .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-v5.md
...
Write file: .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-review-v5.md
