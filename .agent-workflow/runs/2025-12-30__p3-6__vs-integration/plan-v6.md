...
- **Spec Anchors:** Corrected `Public Exports (vs/__init__.py)` anchor to use underscores instead of markdown bolding asterisks to match SSOT verbatim.
- **Verification:** Updated verification commands to target `plan-v6.md`.
...
UV_CACHE_DIR=./.uv_cache uv run --no-sync python scripts/validate_spec_anchors.py .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-v6.md
...
Write file: .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-review-v6.md
