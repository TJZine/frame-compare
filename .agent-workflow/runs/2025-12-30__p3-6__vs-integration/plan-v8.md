...
- Fix Spec Anchor heading: `Public Exports (vs/__init__.py)` (verbatim SSOT)
- Update spec-anchor validation command to `plan-v8.md`
...
- Add VapourSynth module exports and integration tests.
...
UV_CACHE_DIR=./.uv_cache uv run --no-sync python scripts/validate_spec_anchors.py .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-v8.md
...
Read file: .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-v8.md
...
Write file: .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-review-v8.md
