...
- **Spec Anchors:** Corrected `Public Exports (vs/__init__.py)` anchor to exactly match SSOT (fixed residual asterisk typo).
- **Verification:** Updated verification commands to target `plan-v7.md`.
...
UV_CACHE_DIR=./.uv_cache uv run --no-sync python scripts/validate_spec_anchors.py .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-v7.md
...
Write file: .agent-workflow/runs/2025-12-30__p3-6__vs-integration/plan-review-v7.md
