...
OUTPUTS:
  - .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-v2.md
---
...
- Removes the misleading “callable signature” bullet for RunResult (this is a dataclass type, not a planned function).
- Keeps scope, spec anchors, files, tests, and verification commands unchanged.
...
```bash
UV_CACHE_DIR=./.uv_cache uv run --no-sync python scripts/validate_spec_anchors.py .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-v2.md
...
Read file: .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-v2.md
...
Write file: .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-review-v2.md
