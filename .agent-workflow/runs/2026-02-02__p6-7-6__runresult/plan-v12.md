...
- Keeps run-directory hygiene as a required gate (it passed at time of writing; re-run during Verification).
...
```bash
UV_CACHE_DIR=./.uv_cache uv run --no-sync python scripts/validate_spec_anchors.py .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-v12.md
...
Read file: .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-v12.md
...
Write file: .agent-workflow/runs/2026-02-02__p6-7-6__runresult/plan-review-v12.md
