...
- Use repo-local skills under `.codex/skills/` when their trigger descriptions match the task.
...
- Repo-local workflow and boundary skills: [.codex/skills/](.codex/skills/)
