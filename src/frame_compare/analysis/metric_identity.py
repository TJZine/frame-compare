...
def _fast_identity() -> dict[str, object]:
    return {
        ...
        "motion": {
            "temporal": "coarse_to_refined_adjacent_pairs",
            "spatial": "luma_resize",
            "target_max_width": 160,
            "resize": "bicubic",
            "upscale": False,
            "sampled_current_frame_indices": "1_last_and_n_mod_4_eq_0",
            "temporal_stride": 4,
            "coarse_candidate_rule": "min_valid_pairs_max_256_or_1pct",
            "refinement_radius": 8,
            "dense_fill": "zero_outside_refined_windows",
            "operation": "planestats_diff",
        },
    }
