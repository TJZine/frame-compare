...
def _performance_identity() -> dict[str, object]:
    return {
        ...
        "temporal_sampling": {
            ...
            "max_bursts": 8,
            "placement": "centered_contiguous_strata",
        },
        "decoder": {"source": "default", "options": None},
        "luminance": {
            "temporal": "exact_ceil_one_quarter_in_up_to_eight_centered_bursts",
            "spatial": "active_rect_aware_full_resolution_luma",
            "operation": "planestats_average",
        },
        "motion": {
            "temporal": "sampled_burst_pairs_with_per_burst_source_lookbehind",
            "spatial": "active_rect_aware_full_resolution_luma",
            "operation": "planestats_diff",
        },
    }
