...
- FFmpeg and subprocess mechanics: `src/frame_compare/utils/subproc.py`, orchestration preflight/probe modules, and render pipeline owners
- VapourSynth source, color, tonemap, and loader logic: `src/frame_compare/vs/**`
- Render orchestration and overlays: `src/frame_compare/render/**`
- TMDB metadata: `src/frame_compare/services/metadata.py`
- slow.pics publishing: `src/frame_compare/services/publishers.py`
- Browser auto-open: `src/frame_compare/cli_entry.py`
- Docker runtime: `Dockerfile`, `docker-compose.yml`, `tools/verify_docker_integration.sh`
- Windows portable and updater flow: `tools/windows_portable/**`
