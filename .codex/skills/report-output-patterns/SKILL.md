...
- Screenshot naming and render outputs: `src/frame_compare/render/**`
- Overlay text composition: [`src/frame_compare/render/overlay_text.py`](../../../src/frame_compare/render/overlay_text.py)
- Progress display: `src/frame_compare/orchestration/progress.py` and `src/frame_compare/utils/progress.py`
